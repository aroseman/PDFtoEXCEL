 ...
 * @author helios
 */
public class PDFToExcel extends javax.swing.JFrame {
   ...
   static JFileChooser fc = new JFileChooser();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PDFToExcel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PDFToExcel().setVisible(true);
